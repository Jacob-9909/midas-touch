...
const DEFAULT_GLOW_COLOR = '212, 175, 96';
...
const cardData: BentoCardProps[] = [
  {
    color: '#0d1320',
    title: '또래 벤치마킹',
    description: '유사 투자자의 권장 자산배분을 내 현황과 나란히 대조',
    label: 'Benchmark'
  },
  {
    color: '#0d1320',
    title: '세법 근거',
    description: '조항을 인용해 절세·과세 시나리오를 설명',
    label: 'Tax'
  },
  {
    color: '#0d1320',
    title: '실시간 시장',
    description: '환율·금리·유가 스냅샷을 5분 TTL로 재배치',
    label: 'Live'
  },
  {
    color: '#0d1320',
    title: '지식그래프',
    description: '종목·섹터·거시지표를 엮은 근거 네트워크',
    label: 'Graph'
  },
  {
    color: '#0d1320',
    title: '에이전트 상담',
    description: '근거를 인용하며 대화형으로 전략을 제시',
    label: 'Agent'
  },
  {
    color: '#0d1320',
    title: '포트폴리오 전략',
    description: '성향·자산·목표에 맞춘 맞춤 리밸런싱 제안',
    label: 'Strategy'
  }
];
